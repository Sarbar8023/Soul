...
def get_main_keyboard(user_id):
    ...
    keyboard.append([KeyboardButton("🛑 Stop Attack"), KeyboardButton("📊 Check Status")])
    keyboard.append([KeyboardButton("📋 My Access"), KeyboardButton("📈 Attack History")])
